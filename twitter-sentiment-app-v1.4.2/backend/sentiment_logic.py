    ...
    with SessionLocal() as db:
        ...
        for r in rows:
            data.append(dict(
                ...
                ticker=r.ticker,
                mentions=r.mentions,
                interest_score=round(r.interest_score,3),
...
def get_live_snapshot(limit: int = 50):
    with SessionLocal() as db:
        ...
        for t, m, p, n, nn in rows:
            ...
            data.append(dict(ticker=t, interest_score=round(interest,3), sentiment=round(sentiment,3), mentions=int(m or 0), change_vs_avg=round(change_vs_avg,3)))
